...
export const Info = Schema.Struct({
  ...
  reviewer_model: Schema.optional(Schema.String).annotate({
    description:
      "Model used by the auto agent's permission reviewer in the format of provider/model. Defaults to opencode/nemotron-3.5-lightning-free, falling back to the session's chat model when unavailable.",
  }),
